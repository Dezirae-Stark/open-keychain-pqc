 ...
 * CanonicalizedSecretKey#decryptSessionKeyStandaloneMlKem768} for algorithm 100 (standalone
 ...
 * full rationale on session-info reconstruction, which applies verbatim here (algorithm 100
 ...
 */
public class StandaloneMlKem768PublicKeyDataDecryptorFactory extends AbstractPublicKeyDataDecryptorFactory {

    private final CanonicalizedSecretKey mSecretKey;
    private final GenericPgpDataDecryptorHelper mDecryptorHelper;

    public StandaloneMlKem768PublicKeyDataDecryptorFactory(CanonicalizedSecretKey secretKey, String providerName) {
    ...
    public byte[] recoverSessionData(int keyAlgorithm, byte[][] secKeyData, int pkeskVersion) throws PGPException {
        ...
        byte[] rawSessionKey;
        try {
            rawSessionKey = mSecretKey.decryptSessionKeyStandaloneMlKem768(algorithmSpecificData, 0);
        ...
        int symAlgId = StandaloneMlKem768.extractPlaintextSymAlgId(algorithmSpecificData);
